...
const config = {
    serverInfo: {
        ...
        serverName: "TierraPrometida", /*Server name*/
        serverIp: "mc.tierraprometida.top", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        ...
        dueños: [
            {
                inGameName: "McOsa",
                rank: "Dueño",
                skinUrlOrPathToFile: "https://vzge.me/full/832/McOsa.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "DarkMortol",
                rank: "Dueño",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            }
